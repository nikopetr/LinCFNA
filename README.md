...
Due to the large size of the data, the files can be downloaded from the following [google-drive repository](https://drive.google.com/file/d/1e3HkYE4wVWn-YwyHQyajJActTsBHK4x7/view?usp=sharing). 
